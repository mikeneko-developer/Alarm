...
public class DateUtil {
	...
	public static String getDateTimeStringJapan(long time){
		Calendar calendar = Calendar.getInstance();
		calendar.setTimeInMillis(time);
		...
		String date = year + "年" + monthS +"月"+ dayS + "日　" + hourS + "時" + minuteS + "分" + secondS + "秒";
    ...
    public static long getjastDate(long date){
        ...
        int minute = 0;
        int second = 0;
        return DateUtil.getTimeMillis(year, month, day, hour, minute, second);
    }
	...
	public static long getPHPDateTimeStringToLong(String date_text){
		if(date_text == null || date_text.equals("0000-00-00 00:00:00")){
			return 0;
		}
		...
		long date_time = DateUtil.getTimeMillis(year, month, day, hour, minute, second);
	...
	public static long getPHPTimeStringToLong(String date_text){
		if(date_text == null)return 0;
		date_text = date_text.replace("時",":");
		date_text = date_text.replace("分",":");
		date_text = date_text.replace("秒","");
