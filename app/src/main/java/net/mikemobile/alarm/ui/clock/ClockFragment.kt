...
interface ClockFragmentNavigator: BaseNavigator {
}

class ClockFragment: BaseFragment(),ClockFragmentNavigator {
    ...
    override fun onCreateViewBinding(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View?{
        ...
        val binding = DataBindingUtil.inflate<FragmentClockBinding>(inflater, R.layout.fragment_clock, container,false)
